export default function SupportPage() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-16">
      ...
      <p className="mt-4 text-muted">Email support@productfetcher.online or use the form below.</p>
      <form className="mt-8 space-y-4" action="mailto:support@productfetcher.online" method="post" encType="text/plain">
